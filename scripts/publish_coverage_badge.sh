...
# editing a file. This repo carried a hand-set `coverage-90%` badge while the
# enforced floor in pyproject.toml was 88% and the suite measured 90.18%.
#
...
# ubuntu-latest / Python 3.12 leg. The `badges` branch is seeded before this
# script is ever invoked (mnemon-fix/coverage-badge-provenance), so the
